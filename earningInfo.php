...
<div class="container col-sm-4">
	...
	<DIV class="float-left"><select name="relation1[]" class="form-control">
...
<div class="container col-sm-4">
	<DIV class="col-sm-4 ">Annual Income</DIV><span id="EIAnnIncome-error" class="signup-error"></span>
	<DIV class="float-left"><input type="text" name="anlincome[]" id="EIAnnIncome" class="form-control"/></DIV>
...
<div class="container col-sm-4">
	<DIV class="col-sm-4 ">Status</DIV><span id="EIStatus-error" class="signup-error"></span>
	<DIV class="float-left"><input type="text" name="status[]" id="EIStatus" class="form-control"/></DIV>

</div>
<div class="container col-sm-4">
	<DIV class="col-sm-4 ">Prof. Status</DIV><span id="EIProSt-error" class="signup-error"></span>
	<DIV class="float-left"><input type="text" name="prf_status[]" id="EIProSt" class="form-control"/></DIV>
